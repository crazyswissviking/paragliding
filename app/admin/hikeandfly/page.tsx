          ...
          <div style={{ background: "white", borderRadius: "16px", padding: "32px", maxWidth: "650px", width: "90%", maxHeight: "90vh", overflowY: "auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
              ...
              <div>
                ...
                <input type="text" value={bearbeiten.schwierigkeit} onChange={(e) => setBearbeiten({ ...bearbeiten, schwierigkeit: e.target.value })} placeholder="z.B. Mittel" style={inputStyle} />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" value={bearbeiten.tempo_wanderweg} onChange={(e) => setBearbeiten({ ...bearbeiten, tempo_wanderweg: e.target.value })} placeholder="z.B. 3h 30min" style={inputStyle} />
              </div>
              <div>
                <label style={{ display: "block", marginBottom: "4px", fontWeight: "bold", fontSize: "13px" }}>🏃 Tempo H&F Sportlich</label>
                <input type="text" value={bearbeiten.tempo_sportlich} onChange={(e) => setBearbeiten({ ...bearbeiten, tempo_sportlich: e.target.value })} placeholder="z.B. 2h 15min" style={inputStyle} />
              </div>
              <div>
                <label style={{ display: "block", marginBottom: "4px", fontWeight: "bold", fontSize: "13px" }}>🏆 Tempo H&F PB</label>
                <input type="text" value={bearbeiten.tempo_pb} onChange={(e) => setBearbeiten({ ...bearbeiten, tempo_pb: e.target.value })} placeholder="z.B. 1h 45min" style={inputStyle} />
              </div>
              <div style={{ gridColumn: "1 / -1" }}>
                <label style={{ display: "block", marginBottom: "4px", fontWeight: "bold", fontSize: "13px" }}>Route URL</label>
                <input type="text" value={bearbeiten.route_url} onChange={(e) => setBearbeiten({ ...bearbeiten, route_url: e.target.value })} placeholder="https://..." style={inputStyle} />
              </div>
              <div style={{ gridColumn: "1 / -1" }}>
        ...
        <div key={a.id} style={{ border: "1px solid #ddd", borderRadius: "12px", padding: "16px 24px", marginBottom: "12px", opacity: a.aktiv ? 1 : 0.5 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              <button onClick={() => setBearbeiten(a)} style={{ padding: "8px 14px", background: "#f0f4ff", color: "#3355cc", border: "none", borderRadius: "8px", cursor: "pointer", fontSize: "13px", fontWeight: "bold" }}>
                ✏️ Bearbeiten
              </button>
              <button onClick={() => toggleAktiv(a)} style={{ padding: "8px 14px", background: a.aktiv ? "#e6f4ea" : "#f5f5f5", color: a.aktiv ? "#2d6a4f" : "#888", border: "none", borderRadius: "8px", cursor: "pointer", fontSize: "13px", fontWeight: "bold" }}>
                {a.aktiv ? "✅ Aktiv" : "⏸ Inaktiv"}
              </button>
              <button onClick={() => loeschen(a.id)} style={{ padding: "8px 14px", background: "#fdecea", color: "#c0392b", border: "none", borderRadius: "8px", cursor: "pointer", fontSize: "13px", fontWeight: "bold" }}>
                🗑 Löschen
              </button>
            </div>
          </div>
